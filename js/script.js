...
app.controller('ctrlbtnCart', function($scope, $http){
    ...
    //phan quyen` admin
    if (level == 2|| level == 3) {
        $('#btnChangeAdminimg').attr('src','https://storage.googleapis.com/festival-so1/1518067755322logochange.png');
        $('.countCart').attr('style','display:none;');
        localStorage.removeItem("cart");
    }
    //phan quyen user
    else{
        $('#btnChangeAdminimg').attr('src','https://storage.googleapis.com/festival-so1/1518067755338ticket4.png');
        //lấy đơn hàng
